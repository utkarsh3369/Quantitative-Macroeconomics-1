...
B0_diageps= [chol(VAR.SigmaOLS) ones(var_nbr,1)]; % the first 4 columns belong to B_0, the last column are the diagonal elements of SIG_eps
...
IRFpoint = IRFs(VAR.Acomp,impact,nsteps,IRFcumsum,varnames,epsnames);